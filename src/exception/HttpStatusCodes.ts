...
export enum InformationHttpStatusCodes {
    CONTINUE=100,
...
export enum SuccessHttpStatusCodes {
    OK=200,
    CREATED=201,
    ACCEPTED=202,
...
export enum RedirectionHttpStatusCodes {
    MULTIPLE_CHOICES=300,
    MOVED_PERMANENTLY=301,
    FOUND=302,
    SEE_OTHER=303,
    NOT_MODIFIED=304,
    _USE_PROXY=305,             //Deprecated
    _SWITCH_PROXY=306,          //Deprecated
    TEMPORARY_REDIRECT=307,
    PERMANENT_REDIRECT=308,
}

export enum ClientErrorHttpStatusCodes {
    BAD_REQUEST=400,
    UNAUTHORIZED=401,
